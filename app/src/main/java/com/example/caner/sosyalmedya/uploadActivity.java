...
import com.example.caner.sosyalmedya.Manifest.permission;
...
public class uploadActivity extends AppCompatActivity {
    ...
    public void upload (View view){
            ...
            UUID uuid = UUID.randomUUID();//it can give random uniq id
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    newReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(uploadActivity.this, "Post Successfully Uploaded", Toast.LENGTH_SHORT).show();
    ...
    public void chooseImage (View view){
        //İf there is no permission then give permission
        if(ContextCompat.checkSelfPermission(this,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){

                ActivityCompat.requestPermissions(this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},3);

        }else{//İf permission already exist go to gallery
    ...
    //if permission wants for the first time
    @Override
    ...
    //after choosing image what'll happen
    @Override
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {

        if(requestCode == 4 && resultCode == RESULT_OK && data != null){

            selectedImage = data.getData(); //Uri is image adress in here
